...
template <class Type> class BlockK
{
public:
	...
	BlockK(int size, void (*err_function)(char const*) = NULL) { first = last = NULL; block_size = size; error_function = err_function; }

	/* Destructor. Deallocates all items added so far */
	~BlockK() { while (first) { block *next = first -> next; delete[] ((char*)first); first = next; } }
